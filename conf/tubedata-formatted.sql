...
CREATE TABLE branch_stops (id int IDENTITY, station_id varchar(50) NOT NULL, order_no int NOT NULL, branch_id varchar(50) NOT NULL, PRIMARY KEY (id));
...
CREATE TABLE stations (id int IDENTITY, name varchar(50) NOT NULL, line varchar(50) NOT NULL, x varchar(25) NOT NULL, y varchar(25) NOT NULL, PRIMARY KEY  (id));
...
CREATE TABLE stations_test (id int IDENTITY, name varchar(50) NOT NULL, line varchar(50) NOT NULL, x varchar(25) NOT NULL, y varchar(25) NOT NULL, PRIMARY KEY  (id));
...
CREATE TABLE tfl_station_codes (id int IDENTITY, station_id varchar(50) NOT NULL, code char NOT NULL, line varchar(50) NOT NULL, PRIMARY KEY  (id));
