...
$(function(){
	...
	$(".validate-postcode").keyup( function() {
		validatePostcode(this);
	});
	
 	$(".validate-postcode").blur( function() {
		validatePostcode(this);
	});	
 ...
 $(function(){
	...
	if($('#page-links').length != 0){
		...
		$("#main-content h2").each(function(i){		
	  	 ...
	  	 $('#page-links dl').append('<dd><a href="#section-' + (i+1) + '">' + $(this).text() + '</a></dd>'); 
		  });
	}	
});
